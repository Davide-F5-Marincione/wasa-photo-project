...
func (rt *_router) checkFollow(w http.ResponseWriter, r *http.Request, ps httprouter.Params, actx reqcontext.AuthRequestContext) {
	...
	err = json.NewEncoder(w).Encode(rt.db.CheckFollow(givenname, othername))
	if err != nil {
